...
@Component({
  selector: "view-element-html",
  templateUrl: "./view-element-html.component.html",
  styleUrls: ["./view-element-html.component.scss"],
  animations: [scaleIn400ms, fadeInRight400ms],
  encapsulation: ViewEncapsulation.None,
})
export class ViewElementHTMLComponent implements OnInit {
